    ...
    <div className="min-w-screen min-h-screen flex md:items-center md:justify-center justify-center items-start bg-[#f9fafc]">
      <div className="flex flex-col mt-10 md:mt-0 justify-center items-center gap-12 md:gap-10 w-full h-fit p-3">
        <div className="flex flex-col justify-center items-center gap-4">
          <img
            className="h-[1.5rem] w-[1.5rem] md:h-[2.5rem] md:w-[2.5rem]"
            src={Logo}
            alt="Logo"
          />
          <h1 className="text-[20px] md:text-[24px] font-extrabold">
            Sign in to your account
          </h1>
        </div>
        <div className="rounded-xl bg-[#ffffff] p-5 md:p-10 w-full h-fit md:h-fit md:w-[25rem] flex flex-col gap-10">
